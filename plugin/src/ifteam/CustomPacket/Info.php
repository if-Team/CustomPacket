...
class Info{
    ...
    const PACKET_SEND = 0x00;
    //const PACKET_RECV = 0x01;
    const PACKET_SEND_ENCRYPTED = 0x02; //Reserved for future use
    //const PACKET_RECV_ENCRYPTED = 0x03; //Reserved for future use
    //0x04~0xdf: Reserved
